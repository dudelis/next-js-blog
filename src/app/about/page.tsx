...
const About: React.FunctionComponent<IAboutProps> = (props) => {
  return (
    <section className="flex flex-col items-center justify-center gap-8 mt-8">
      ...
      {/* <p className="text-lg font-light">Welcome to Code Musician Blog, where ones and zeros dance with melodies, and binary harmonizes with beats! Strum along with me as we explore the intersection of music and tech. From “How to Tune Your Guitar (and Your Wi-Fi)” to “APIs in A Minor,” we’ll hit all the right notes. And if you’ve ever wondered what a software engineer’s favorite chord is, it’s definitely “C# Major” (because it’s sharp).</p> */}
    </section>
  );
};
